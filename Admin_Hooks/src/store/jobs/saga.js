...
import { GET_JOB_LIST, ADD_NEW_JOB_LIST, UPDATE_JOB_LIST, DELETE_JOB_LIST, GET_APPLY_JOB, DELETE_APPLY_JOB, 
    FETCH_BLOG_FAILURE,
    FETCH_BLOG_SUCCESS,
    FETCH_BLOG_REQUEST } from "./actionTypes";
import {
    getJobListSuccess,
    getJobListFail,
    addJobListSuccess,
...
import {
  ...
  function* fetchBlog() {
    try {
      const response = yield call(axios.get, 'http://127.0.0.1:8000/board/blog');
  ...
  function* blogSaga() {
    yield takeEvery(FETCH_BLOG_REQUEST, fetchBlog);
  }
